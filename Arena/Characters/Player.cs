...
namespace Arena
{
    class Player : Fighter
    {
        ...
        public Player(string name, int maxHp=0, int maxEnergy = 0, int strength = 10, int agility = 10, int intellect = 10, int armor = 0) : base(name, maxHp, maxEnergy, strength, agility, intellect, armor)
        {
